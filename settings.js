...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || "𝙳𝙾𝚁𝙰-𝙼𝙳=deFmRBZR#UIo4yeB0Lq9b6Xumb1fD1Q96C5KtOpzhI1Ahs3akQkI",
    ...
    AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*SEEN YOUR STATUS BY HASHUZZ MD 😆*",
...
ᴋᴇᴇᴘ ᴜsɪɴɢ ✦ʜᴀꜱʜᴜᴢz ᴍᴅ✦ ғʀᴏᴍ ᴅɪɴɪᴛʜɪ & ᴅᴏʀᴀ⚡

*© ᴡʜᴀᴛꜱᴀᴘᴘ ʙᴏᴛ ʜᴀꜱʜᴜᴢᴢ- ᴍᴅ*

> ɢɪᴛʜᴜʙ : github.com/`,
    // add alive msg here 

    STICKER_NAME: process.env.STICKER_NAME || "ʜᴀꜱʜᴜᴢᴢ-ᴍᴅ",
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "94763007898",
    // add your bot owner number

    OWNER_NAME: process.env.OWNER_NAME || "ᴅɪɴɪᴛʜɪ",
    // add bot owner name

    DESCRIPTION: process.env.DESCRIPTION || "*© ᴘᴏᴡᴇʀᴇᴅ ʙʏ ʀᴇᴀʟ ᴅᴏʀᴀ*",
    ...
    DEV: process.env.DEV || "94763007898",
...
`*Hᴇʟʟᴏ ᴛʜᴇʀᴇ ʜᴀꜱʜᴜᴢᴢ ᴍᴅ ᴄᴏɴɴᴇᴄᴛᴇᴅ! 👋🏻* 

*ᴋᴇᴇᴘ ᴏɴ ᴜsɪɴɢ ᴅᴏʀᴀ ᴍᴏᴅs 📍* 
